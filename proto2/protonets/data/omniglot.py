...
OMNIGLOT_DATA_DIR  = os.path.join('/home/public/b509/code/g21/shy/aaa/proto/proto2/data/omniglot')
OMNIGLOT_CACHE = { }
...
def load_class_images(d):
    if d['class'] not in OMNIGLOT_CACHE:
        ...
        image_dir = os.path.join(OMNIGLOT_DATA_DIR, 'dataset/dataset', alphabet, character)
        ...
        image_ds = TransformDataset(ListDataset(class_images),
                                    compose([partial(convert_dict, 'file_name'),
                                             ...
                                             partial(scale_image, 'data', 56, 56),
