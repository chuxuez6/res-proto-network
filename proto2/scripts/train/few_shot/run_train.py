...
parser.add_argument('--data.way', type=int, default=8, metavar='WAY',
...
parser.add_argument('--data.test_way', type=int, default=8, metavar='TESTWAY',
                    help="number of classes per episode in test. 0 means same as data.way (default: 4)")
...
parser.add_argument('--model.x_dim', type=str, default='1,56,56', metavar='XDIM',
                    help="dimensionality of input images (default: '1,56,56')")
...
parser.add_argument('--train.patience', type=int, default=50, metavar='PATIENCE',
...
print('Time cost on GPU = %fs' % (end - start))
